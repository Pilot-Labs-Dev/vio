...
#ifndef VIO_SPARSE_IMG_ALIGN_H_
#define VIO_SPARSE_IMG_ALIGN_H_
...
class SparseImgAlign : public vk::NLLSSolver<3, SE2>
{
...
public:
  ...
  Matrix<double, 3, 3> getFisherInformation();
...
protected:
  ...
  // cache:
  Matrix<double, 3, Dynamic, ColMajor> jacobian_cache_;
